...
if __name__ == '__main__':
    ...
    backgrounds = ['fg20', 'hm12', 'hm12_orig', 'hm01']
    temp = 4.
    hdens_min = -4.
    hdens_max = -1.
    redshift = 0.
    linestyles = ['-', '--', ':', '-.']
    uvb_labels = [r'$\textrm{FG20}$', r'$\textrm{HM12-new}$', r'$\textrm{HM12-orig}$', r'$\textrm{HM01}$']
    ...
    line_hm_orig = Line2D([0,1],[0,1],ls=linestyles[2], marker=None, color='grey')
    line_hm_spec = Line2D([0,1],[0,1],ls=linestyles[3], marker=None, color='grey')

    leg_uvb = ax.legend([line_fg, line_hm, line_hm_orig, line_hm_spec],uvb_labels, loc=3, fontsize=12)
    ...
    for b, background in enumerate(backgrounds):
        if background == 'fg20':
            ...
            ion_table_file = '/home/sapple/ion_tables/HM12_oppenheimer_style/lt00000f100_i31'
            ions_start_from = 2
        ...
        if background in ['fg20', 'hm12', 'hm01']:
